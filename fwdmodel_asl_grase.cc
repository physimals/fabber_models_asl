...
void GraseFwdModel::Evaluate(const ColumnVector& params,
...
void GraseFwdModel::SetupARD(const MVNDist& theta, MVNDist& thetaPrior,
		double& Fard) const
{
...
void GraseFwdModel::UpdateARD(const MVNDist& theta, MVNDist& thetaPrior,
		double& Fard) const
{
	int ardindex = ard_index();
